...
import { 
  ArrowDownRight, ArrowUpRight, Eye, EyeOff, 
...
export default function DashboardPage() {
  ...
  return (
    <div className="transition-colors duration-500 rounded-3xl">
      
      {/* গ্রিটিংস (থিম বাটন সরানো হয়েছে) */}
      <div className="flex justify-between items-center mb-8">
        <div className="flex items-center gap-3">
          <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-2xl text-red-600 dark:text-red-500 transition-colors">
            <HandCoins size={24} />
          </div>
          <div>
